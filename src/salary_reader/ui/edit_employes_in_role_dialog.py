...
"color: white;")
        ...
        self.frame_edit_employees_in_role = QFrame(Dialog)
        self.frame_edit_employees_in_role.setObjectName(u"frame_edit_employees_in_role")
        self.frame_edit_employees_in_role.setStyleSheet(u"background-color: rgba(255, 255, 255, 30);\n"
"border: 1px solid rgba(255, 255, 255, 40);\n"
"border-radius: 7px;\n"
"color: white;")
        self.horizontalLayout = QHBoxLayout(self.frame_edit_employees_in_role)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.layout_all_employees = QVBoxLayout()
        self.layout_all_employees.setObjectName(u"layout_all_employees")
        self.label_all_employees = QLabel(self.frame_edit_employees_in_role)
        self.label_all_employees.setObjectName(u"label_all_employees")
        self.label_all_employees.setStyleSheet(u"color: white;\n"
"font-weight: bold;\n"
"font-size: 11pt;\n"
"background-color: none;\n"
"border: none;")

        self.layout_all_employees.addWidget(self.label_all_employees)

        self.search_all_employees = QLineEdit(self.frame_edit_employees_in_role)
        ...
        self.table_all_employees = QTableWidget(self.frame_edit_employees_in_role)
        self.table_all_employees.setObjectName(u"table_all_employees")
        self.table_all_employees.setStyleSheet(u"QTableWidget {\n"
...
"    }")
        ...
        self.table_all_employees.setAlternatingRowColors(True)
        ...
        self.table_all_employees.horizontalHeader().setStretchLastSection(True)
        ...
        self.button_add_to_role = QPushButton(self.frame_edit_employees_in_role)
...
"}")
        ...
        self.button_delete_from_role = QPushButton(self.frame_edit_employees_in_role)
...
"}")
        ...
        self.layout_role_employees = QVBoxLayout()
        self.layout_role_employees.setObjectName(u"layout_role_employees")
        self.label_employees_in_role = QLabel(self.frame_edit_employees_in_role)
        self.label_employees_in_role.setObjectName(u"label_employees_in_role")
        self.label_employees_in_role.setStyleSheet(u"color: white;\n"
"font-weight: bold;\n"
"font-size: 11pt;\n"
"background-color: none;\n"
"border: none;")

        self.layout_role_employees.addWidget(self.label_employees_in_role)

        self.table_role_employees = QTableWidget(self.frame_edit_employees_in_role)
        self.table_role_employees.setObjectName(u"table_role_employees")
        self.table_role_employees.setStyleSheet(u"QTableWidget {\n"
"        gridline-color: rgba(255, 255, 255, 70);\n"
"    }\n"
"    QHeaderView::section {\n"
"        padding: 3px;  \n"
"    }")
        ...
        self.table_role_employees.horizontalHeader().setProperty(u"showSortIndicator", True)
        self.table_role_employees.horizontalHeader().setStretchLastSection(True)
        self.table_role_employees.verticalHeader().setVisible(False)

        self.layout_role_employees.addWidget(self.table_role_employees)


        self.horizontalLayout.addLayout(self.layout_role_employees)

        self.horizontalLayout.setStretch(1, 1)

        self.gridLayout.addWidget(self.frame_edit_employees_in_role, 0, 0, 1, 4)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_all_employees.setText(QCoreApplication.translate("Dialog", u"\u0412\u0441\u0435 \u0441\u043e\u0442\u0440\u0443\u0434\u043d\u0438\u043a\u0438:", None))
        ...
        self.label_employees_in_role.setText(QCoreApplication.translate("Dialog", u"\u0421\u043e\u0442\u0440\u0443\u0434\u043d\u0438\u043a\u0438 \u0432 \u0432\u044b\u0431\u0440\u0430\u043d\u043d\u043e\u0439 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0435 \u043c\u043e\u0442\u0438\u0432\u0430\u0446\u0438\u0438:", None))
