...
from ..models import Employee, MotivationProgram
from ..core.control_models import assign_motivation_program
from ..ui.edit_employes_in_role_dialog import Ui_Dialog
from ..ui.styles import WARNING_DIALOG_STYLE
